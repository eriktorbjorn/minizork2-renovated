...
<SYNTAX DESTROY OBJECT = V-MUNG>
<SYNTAX DESTROY OBJECT WITH OBJECT (HELD CARRIED TAKE) = V-MUNG>
<SYNTAX DESTROY DOWN OBJECT WITH OBJECT (HELD CARRIED TAKE) = V-MUNG>
...
<SYNTAX DROP OBJECT (HELD MANY HAVE) DOWN OBJECT = V-PUT>
<SYNTAX DROP OBJECT (HELD MANY HAVE) IN OBJECT = V-PUT>
<SYNTAX DROP OBJECT (HELD MANY HAVE) ON OBJECT = V-PUT-ON>
...
<SYNTAX EXAMINE IN OBJECT (HELD CARRIED IN-ROOM ON-GROUND MANY) = V-LOOK-INSIDE>
<SYNTAX EXAMINE ON OBJECT (HELD CARRIED IN-ROOM ON-GROUND MANY) = V-LOOK-INSIDE>
...
<SYNTAX MOVE OBJECT (HELD MANY HAVE) IN OBJECT = V-PUT>
...
<SYNTAX PUT OBJECT (HELD MANY HAVE) IN OBJECT = V-PUT>
<SYNTAX PUT OBJECT (HELD MANY HAVE) ON OBJECT = V-PUT-ON>
...
<SYNTAX THROW OBJECT (HELD CARRIED HAVE) WITH OBJECT (FIND ACTORBIT)
	(ON-GROUND IN-ROOM) = V-THROW>
<SYNTAX THROW OBJECT (HELD CARRIED HAVE) IN OBJECT = V-PUT>
<SYNTAX THROW OBJECT (HELD CARRIED HAVE) ON OBJECT = V-PUT-ON>
